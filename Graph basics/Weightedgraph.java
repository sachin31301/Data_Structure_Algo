...
public class Weightedgraph {
    public static void main(String args[]) {
        Graphc gp= new Graphc(5);
        gp.addedge(0, 1, true, 3);
        gp.addedge(1, 4, true, 2);
        gp.addedge(2, 4, true, 4);
        gp.addedge(3, 1, true, 5);
        gp.addedge(4, 3, true, 1);
        gp.addedge(0, 2, true, 0);
...
class Graphc{
    ...
    public  void addedge(int u, int v,boolean dir,int dist){
        ...
        if(dir==true){
            graph.get(v).add(new edge(v,dist));
        }
    }
